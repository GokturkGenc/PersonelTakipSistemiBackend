...
namespace WebAPI.Controllers
{
    ...
    public class RentalsController : ControllerBase
    {
        ...
        [HttpGet("getbydate")]
        public IActionResult GetByDate(DateTime rentDate)
        {
            var result = _rentalService.GetByDate(rentDate);
        ...
        [HttpGet("iscarrented")]
        public IActionResult IsCarRented(int cardId)
        {
            var result = _rentalService.IsCarRented(cardId);
            if (result.Success)
            {
                return Ok(result);
            }
